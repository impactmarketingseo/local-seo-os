...
{/* SEO Tab - show content JSON */}
        ...
        {activeTab === 'hero' && (
          <div className="card-standard">
            ...
            <pre className="text-xs mono text-text-secondary overflow-x-auto bg-sidebar p-4 rounded-md max-h-[600px]">
              {(() => { try { return JSON.stringify(content?.hero || {}, null, 2); } catch(e) { return String(content?.hero || {}); } })()}
            </pre>
          </div>
        )}
        ...
        {activeTab === 'problems' && (
          <div className="card-standard">
            ...
            <pre className="text-xs mono text-text-secondary overflow-x-auto bg-sidebar p-4 rounded-md max-h-[600px]">
              {(() => { try { return JSON.stringify(content?.problems || {}, null, 2); } catch(e) { return String(content?.problems || {}); } })()}
            </pre>
          </div>
        )}
        ...
        {activeTab === 'why' && (
          <div className="card-standard">
            ...
            <pre className="text-xs mono text-text-secondary overflow-x-auto bg-sidebar p-4 rounded-md max-h-[600px]">
              {(() => { try { return JSON.stringify(content?.why_choose_us || {}, null, 2); } catch(e) { return String(content?.why_choose_us || {}); } })()}
            </pre>
          </div>
        )}
        ...
        {activeTab === 'process' && (
          <div className="card-standard">
            ...
            <pre className="text-xs mono text-text-secondary overflow-x-auto bg-sidebar p-4 rounded-md max-h-[600px]">
              {(() => { try { return JSON.stringify(content?.process || {}, null, 2); } catch(e) { return String(content?.process || {}); } })()}
            </pre>
          </div>
        )}
        ...
        {activeTab === 'faq' && (
          <div className="card-standard">
            ...
            <pre className="text-xs mono text-text-secondary overflow-x-auto bg-sidebar p-4 rounded-md max-h-[600px]">
              {(() => { try { return JSON.stringify(content?.faq || {}, null, 2); } catch(e) { return String(content?.faq || {}); } })()}
            </pre>
          </div>
        )}
        ...
        {activeTab === 'local' && (
          <div className="card-standard">
            ...
            <pre className="text-xs mono text-text-secondary overflow-x-auto bg-sidebar p-4 rounded-md max-h-[600px]">
              {(() => { try { return JSON.stringify(content?.local_context || {}, null, 2); } catch(e) { return String(content?.local_context || {}); } })()}
            </pre>
          </div>
        )}
        ...
        {activeTab === 'schema' && (
          <div className="card-standard">
            ...
            <pre className="text-xs mono text-text-secondary overflow-x-auto bg-sidebar p-4 rounded-md max-h-[600px]">
              {(() => { try { return JSON.stringify(content?.schema_markup || {}, null, 2); } catch(e) { return String(content?.schema_markup || {}); } })()}
            </pre>
          </div>
        )}
